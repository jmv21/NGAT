...
namespace NGAT.Business.Domain.Core
{
    ...
    public class Node : GraphDependantEntity, IComparable<Node>
    {
        ...
        /// <summary>
        ///  If the node is the result of split a node of the graph, the pair node is his pair.
        /// </summary>
        public int PairNode { get; set; }

        /// <summary>
        /// True if this node is the result of split a node of the graaph.
        /// </summary>
        public bool HasPairNode { get; set; } = false;
    }
